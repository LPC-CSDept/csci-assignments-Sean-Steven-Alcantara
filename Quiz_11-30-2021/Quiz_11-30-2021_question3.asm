#
# Quiz_11-30-2021_question3.asm
# Sean Steven Alcantara
# 11/25/2021
# Quiz Due on 11/30/2021 Question #3 for CSCI 21
...
#
	...
	.data
prompt:	.asciiz "Enter a float value for n: "
nval:	.asciiz	"n = "
nroot:	.asciiz "\nsquare root of n = "
...
main:	la	$a0, prompt	# address of prompt message
